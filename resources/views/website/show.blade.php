                        ...
                        <div class="product-info-content">
                            ...
                            <div class="product-share">
                                ...
                                <div class="social-icons">
                                    ...
                                    <a href="https://www.twitter.com/intent/tweet?url={{ $shareUrl }}"
                                        target="_blank" rel="noopener ">
                                        <span class="twitter">
                ...
                <nav>
                    <div class="nav nav-tabs nav-item" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="nav-review-tab" data-bs-toggle="tab" data-bs-target="#nav-review"
                            ...
                            aria-selected="false">{{ __('website.review') }}</button>
                ...
                <div class="tab-content tab-item" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab"
                        ...
                        <div class="product-review-section">
                            <h5 class="intro-heading">{{ __('website.review') }}</h5>
                            @foreach ($product->productPreviews as $item)
                                <div class="review-wrapper">
                                    <div class="wrapper">
                                        <div class="wrapper-aurthor">
                                            <div class="wrapper-info">
                                                <div class="aurthor-img">
                                                    <img src="assets/website/assets/images/homepage-one/aurthor-img-1.webp"
                                                        alt="aurthor-img">
                                                </div>
                                                <div class="author-details">
                                                    <h5>{{ $item->user->name }}</h5>
                                                    <p>{{ $item->user->country->name }}, {{ $item->user->city->name }}</p>
                                                </div>
                                            </div>
                                            <div class="ratings">
                                                <span>
    ...
    <section class="product weekly-sale product-weekly footer-padding">
        <div class="container">
            <div class="section-title">
                ...
                <a href="{{ route('website.products.by.type', 'related-products') }}"
