                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-12">
                                <div class="countdown-section">
                                    ...
                                    <div class="countdown-items">
                                        ...
                                        <span class="text">{{ __('website.minuts') }}</span>
                                    </div>
                                    <div class="countdown-items">
                            ...
                            <div class="col-lg-12">
                                <div class="product-sorting-section">
                                    <div class="result">
                                        <p>{{ __('website.showing') }} <span>{{ $products->firstItem() }}–{{ $products->lastItem() }} {{ __('website.of') }} {{ $products->total() }} results</span></p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="product-wrapper" data-aos="fade-up">
                                        <div class="product-img">
                                            ...
                                            <div class="position-absolute top-0 start-0 bg-danger text-white py-1 px-2 mt-2 rounded">
                                                {{ $product->brand->name }}
                                            </div>
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="product-description">
                                                <a href="{{ route('website.products.show' , $product->slug) }}" class="product-details">{{ $product->name }}
                                                </a>
                                                <div class="price">
                                                    ...
                                                    <span class="new-price">{{ __('website.has_variants') }} EGP</span>
                                                    @endif
                                        ...
                                        <div class="product-cart-btn">
                                            <a href="cart.html" class="product-btn">{{ __('website.view_details') }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
