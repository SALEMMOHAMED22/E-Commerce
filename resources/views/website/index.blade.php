                    ...
                    <div class="wrapper-img">
                        <span>
                            <svg width="94" height="82" viewBox="0 0 94 82" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M58.256 40.0336L70.0806 40.0336L46.9682 -2.64059e-05L29.516 30.2262C35.3719 40.3689 41.2279 50.5174 47.0898 60.663L47.2738 60.9804L70.3506 60.9804L76.2304 71.1617L64.5332 71.1617L53.1476 71.1617L59.0955 81.4616C70.7333 81.4615 82.3652 81.4615 94 81.4615L76.1799 50.5945C68.3393 50.5945 60.5016 50.5945 52.661 50.5945L41.1212 30.6059L46.9653 20.4751L58.256 40.0336Z" fill="white" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M35.3604 60.9805L29.4777 71.1647L17.7865 71.1647L23.6662 60.9805L29.6498 50.6243L26.7099 45.5307L23.7344 40.3808L23.5327 40.7308L0.0108757 81.4646L11.8356 81.4646L23.5327 81.4646L35.1586 81.4646L41.1036 71.1647L41.3053 70.8176L35.6303 60.9805L35.3604 60.9805Z" fill="#F11921" />
                            </svg>
                        </span>
                    </div>
                    <div class="wrapper-info">
                    ...
                    <div class="wrapper-img">
                        <span>
                            <svg width="78" height="79" viewBox="0 0 78 79" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M35.2249 0C44.9888 0.0598183 53.8176 4.04043 60.2181 10.4464C66.6758 16.9041 70.6727 25.8225 70.6727 35.6735C70.6727 36.8399 70.6156 37.9982 70.5041 39.1402H62.9697C63.1056 38.0064 63.1791 36.8481 63.1791 35.6735C63.1791 27.8889 60.0278 20.8494 54.9296 15.7458C49.8804 10.6993 42.9143 7.55613 35.2276 7.49903V0H35.2249Z" fill="#98C73A" />
                                <path d="M0 39.143C0.932622 30.9071 4.66586 23.5168 10.229 17.951C16.6322 11.5477 25.4608 7.56433 35.2248 7.50452V15.0008C27.5381 15.0634 20.5721 18.2011 15.5202 23.2558C11.322 27.4539 8.44521 32.979 7.55881 39.143H0Z" fill="#CC4645" />
                                <path d="M78.0001 39.1429C77.0729 47.3816 73.3451 54.7691 67.7793 60.3322C61.376 66.7328 52.5474 70.7216 42.7861 70.7868V63.2851C50.4728 63.228 57.4361 60.0848 62.4881 55.0356C66.6862 50.832 69.563 45.3124 70.4494 39.1429H78.0001Z" fill="#F4C257" />
                                <path d="M7.33292 42.6124C7.33292 41.4378 7.38997 40.2849 7.4933 39.1429H15.0358C14.8917 40.2795 14.8264 41.4351 14.8264 42.6124C14.8264 50.3942 17.9778 57.4365 23.076 62.5374C28.1279 67.5866 35.0831 70.7243 42.7806 70.7868V78.2831C33.0166 78.2206 24.188 74.2454 17.7766 67.8285C11.3216 61.379 7.33292 52.4607 7.33292 42.6124Z" fill="#2491EB" />
                            </svg>
                        </span>
                    </div>
                    <div class="wrapper-info">
