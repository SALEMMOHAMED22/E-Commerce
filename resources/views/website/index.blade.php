...
@section('content')
            ...
            <div class="swiper-wrapper hero-wrapper">
                @foreach ($sliders as $item)
                    <div class="swiper-slide hero-slider-one"
                        style="background:url({{ asset($item->file_name) }}) no-repeat center center; background-size:cover; ">
                        <div class="container">
                            <div class="col-lg-6">
    ...
    <section class="product-category">
        <div class="container">
            ...
            <div class="category-section">
                @foreach ($someCategories as $item)
    ...
    {{-- New Arrival Section --}}
    @if ($homePageProducts['new_arrivals']->count() > 0)
        <section class="product arrival">
            <div class="container">
                ...
                <div class="arrival-section">
                    <div class="row g-5">
                        @foreach ($homePageProducts['new_arrivals'] as $item)
    ...
    @if($homePageProducts['flash_products_timer']->count() > 0)
        <section class="product flash-sale">
            <div class="container">
                <div class="section-title">
                    ...
                    <a href="{{ route('website.products.by.type' , 'flash-products-timer') }}" class="view">{{ __('website.view_all') }}</a>
                </div>
                <div class="flash-sale-section">
                    <div class="row g-5">
                        @foreach ($homePageProducts['flash_products_timer'] as $item)
    ...
    <!--flash Sale Product -->
    @if ($homePageProducts['flash_products']->count() > 0)
        <section class="product best-product">
            <div class="container">
                ...
                <div class="best-product-section">
                    <div class="row g-4">
                        @foreach ($homePageProducts['flash_products'] as $item)
