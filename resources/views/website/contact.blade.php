    ...
    <section class="blog about-blog">
        <div class="container">
            <div class="blog-bradcrum">
                ...
                <span><a href="#">{{ __('website.contact') }}</a></span>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="contact-info-section">
                            <div class="contact-information">
                                <h5 class="wrapper-heading">{{ $setting->site_name }}</h5>
                                <p class="paragraph">
                                    {{ $setting->desc }}
                                </p>
                                                ...
                                                <div class="wrapper-content">
                                                    ...
                                                    <p class="paragraph">
                                                        <a href="mailto:{{ $setting->site_email }}"
                                                            class="__cf_email__">{{ $setting->site_email }}</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="address">
                                                <div class="contact-address">
                                                    ...
                                                    <div class="address-content">
                                                        <h5 class="wrapper-heading">{{ __('website.address') }}</h5>
                                                        <p class="paragraph">
