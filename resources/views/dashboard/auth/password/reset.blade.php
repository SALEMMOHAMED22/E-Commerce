                                        ...
                                        <form class="form-horizontal" action="{{ route('dashboard.password.reset.post') }}" method="POST">
                                          @csrf
                                            <fieldset hidden class="form-group position-relative has-icon-left">
                                                <input name="email" value="{{ $email }}" type="email" class="form-control form-control-lg input-lg"
                                                    id="user-email">
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input name="password" type="password" class="form-control form-control-lg input-lg"
                                                    id="user-email" placeholder="Your new Password" >
                                                    @error('password')
                                            ...
                                            <fieldset class="form-group position-relative has-icon-left">
                                                <input name="password_confirmation" type="password" class="form-control form-control-lg input-lg"
                                                    id="user-email" placeholder="confirm new password" required>
                                                <div class="form-control-position">
                                                    <i class="ft-mail"></i>
                                                </div>
                                            </fieldset>
