    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="index.html"><i class="la la-folder"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{ route('dashboard.categories.index') }}"
            ...
            <li class=" nav-item"><a href="index.html"><i class="la la-tag"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{ route('dashboard.brands.index') }}"
            ...
            <li class=" nav-item"><a href="index.html"><i class="la la-ticket"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{ route('dashboard.coupons.index') }}"
            ...
            <li class=" nav-item"><a href="index.html"><i class="la la-home"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{ route('dashboard.admins.index') }}"
            ...
            <li class=" nav-item"><a href="#"><i class="la la-home"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{ route('dashboard.users.index') }}"
        ...
        <li class=" nav-item"><a href="index.html"><i class="la la-home"></i><span class="menu-title"
                    ...
                    class="badge badge badge-info badge-pill float-right mr-2"></span></a>
            <ul class="menu-content">
                <li class=""><a class="menu-item" href="{{ route('dashboard.products.index') }}"
        ...
        <li class=" nav-item"><a href="index.html"><i class="la la-home"></i><span class="menu-title"
                    ...
                    class="badge badge badge-info badge-pill float-right mr-2"></span></a>
            <ul class="menu-content">
                <li class=""><a class="menu-item" href="{{ route('dashboard.settings.index') }}"
        ...
        <li class=" nav-item"><a href="index.html"><i class="la la-home"></i><span class="menu-title"
                    data-i18n="nav.dash.main">{{ __('dashboard.orders') }}</span><span
                    class="badge badge badge-info badge-pill float-right mr-2"></span></a>
            <ul class="menu-content">
                <li class=""><a class="menu-item" href="{{ route('dashboard.orders.index') }}"
                        data-i18n="nav.dash.ecommerce">{{ __('dashboard.orders') }}</a>
                </li>
                {{-- <li><a class="menu-item" href="{{ route('dashboard.pages.create') }}"
                        data-i18n="nav.dash.crypto">{{ __('dashboard.create_page') }}</a>
                </li> --}}
        ...
        <li class=" nav-item"><a href="#"><i class="la la-header"></i><span class="menu-title"
            ...
            <ul class="menu-content">
                ...
                <li><a class="menu-item" href="headers-breadcrumbs-with-description.html"
                        data-i18n="nav.page_headers.headers_breadcrumbs_breadcrumbs_with_description">Breadcrumbs with
                        desc</a>
                </li>
