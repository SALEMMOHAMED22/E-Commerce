            ...
            <div class="header-top">
                <div class="header-profile">
                    @if (Auth::guard('web')->check())
                        <a href="{{ route('website.profile') }}"><span>{{ Auth::guard('web')->user()->name }}</span></a>
                    @endif
                    <a href="order.html"><span>{{ __('website.order_tracking') }}</span></a>
                    <a href="{{ route('website.faqs.index') }}"><span>{{ __('website.support') }}</span></a>
                </div>
                <div class="header-contact d-none d-lg-block">
                    <a href="#">
                        <span>{{ __('website.need_help') }} {{ __('website.call_us') }}:</span>
            ...
            <div class="header-nav">
                                        ...
                                        <a href="product-sidebar.html">
                                            <div class="dropdown-item">
                                                <div class="dropdown-list-item">
                                                    <span class="dropdown-img">
                                                        <img src="{{ asset($item->icon) }}" alt="dress">
                                                    </span>
                                                    <span class="dropdown-text">
                                                        {{ $item->name }}
                                                    </span>
                ...
                <div class="header-nav-menu">
                    <ul class="menu-list">
                                       ...
                                       @foreach ($categories_children as $item)
                                            ...
                                            <ul>
                                              @foreach ($item->children as $child)
                                                    <li><a href="product-sidebar.html">{{ $child->name }}</a></li>
                                              @endforeach
                        ...
                        <li>
                            <a href="blogs.html">
                                <span class="list-text">{{ __('website.blogs') }}</span>
                            </a>
                            <ul class="header-sub-menu">
                                <li><a href="blogs-details.html">{{ __('website.blogs_details') }}</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="{{ route('website.profile') }}">
                                <span class="list-text">{{ __('website.profile') }}</span>
                            </a>
                        </li>
                        <li>
                ...
                <div class="header-vendor-btn">
                    @if (app()->getLocale() == 'ar')
                        <a href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}" class="shop-btn">
                    ...
                    @else
                        <a href="{{ LaravelLocalization::getLocalizedURL('ar', null, [], true) }}" class="shop-btn">
